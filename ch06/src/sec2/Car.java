...
public class Car {
	...
	int speed;
	final static int MAX_SPEED = 500;	//멤버 상수 : 값이 한 곳에 저장되어 더 이상 바꾸지 않음 (앞에 수정자를 작성해야 함 final static , 상수명은 대문자로)
	...
	//return (반환값)이 없으므로 반환타입에는 void를 지정해야 함
	public void bootUp(){
	...
	public int speedInfo(){	//get speed랑 같은 내용임
		return speed;
	}
