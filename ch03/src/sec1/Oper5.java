...
public class Oper5 {
	...
	public static void main(String[] args) {
		...
		System.out.println("d >> 2 =>"+(d >> 2)); // 오른쪽 시프트(shift)
		System.out.println("d << 2 =>"+(d << 2)); // 왼쪽 시프트(shift)
		System.out.println("d >>> 2 =>"+(d >>> 2)); // 오른쪽 이중시프트
		System.out.println("d <<< 2 는 존재하지 않음"); //왼쪽 이중시프트는 연산자가 없음
		//연산시 부정과 불능 그리고 예외처리
		// System.out.println(a / 0);  // Not a Number => NaN(부정)
		// System.out.println("k"/0);  //문자('')는 나눌수 있지만 문자열("")은 안됨
